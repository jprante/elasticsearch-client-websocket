...
/**
 * An flush action request builder.
 */
public class FlushRequestBuilder extends BaseIngestRequestBuilder<FlushRequest, FlushResponse> {

    private final WebSocketIngestClient client;
    
    public FlushRequestBuilder(WebSocketIngestClient client) {
