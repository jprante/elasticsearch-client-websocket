...
/**
 */
public class FlushAction extends Action<FlushRequest, FlushResponse, FlushRequestBuilder, WebSocketIngestClient> {
    ...
    @Override
    public FlushRequestBuilder newRequestBuilder(WebSocketIngestClient client) {
